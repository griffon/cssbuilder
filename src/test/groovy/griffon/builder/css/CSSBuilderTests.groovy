...
public class CSSBuilderTests extends GroovySwingTestCase {
    ...
    void testCssClassAttribute() {
        testInEDT {
            ...
            assert "active" == builder.button.getClientProperty(ClarityConstants.CLIENT_PROPERTY_CLASS_KEY).toString()
        }
    }
...
*/
    ...
    void testBorders() {
        testInEDT {
            ...
            assert BorderUtils.getBorderColor(builder.button0.border) == Color.BLUE
